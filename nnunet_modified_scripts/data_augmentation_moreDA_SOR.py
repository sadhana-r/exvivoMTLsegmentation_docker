...
from nnunet.training.data_augmentation.downsampling_SOR import DownsampleSegForDSTransform3, DownsampleSegForDSTransform2
from nnunet.training.data_augmentation.pyramid_augmentations import MoveSegAsOneHotToData, \
    ApplyRandomBinaryOperatorTransform, \
    RemoveRandomConnectedComponentFromOneHotEncodingTransform

from nnunet.training.data_augmentation.move_datachannel_to_seg import MoveLaplaceToSeg
try:
...
def get_moreDA_augmentation(dataloader_train, dataloader_val, patch_size, params=default_3D_augmentation_params,
    ...
    #order_seg = 3 #why is order_seg 3?? - removed this on 3/31
    ...
    print(params.get("cascade_do_cascade_augmentations"))
